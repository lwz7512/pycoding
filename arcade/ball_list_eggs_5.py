...
class Ball:
    ...
    def __init__(self, position_x, position_y, change_x, change_y, radius, color):
        ...
        self.radius = radius
        self.color = color
        self.angle = angle = random.random() * 100
    ...
    def draw(self):
        ...
        arcade.draw_ellipse_filled(self.position_x, self.position_y, 25, 36, self.color, self.angle)

    def update(self):
        """ Code to control the ball's movement. """

        # Move the ball
        self.position_y += self.change_y * 2
        self.position_x += self.change_x * 2

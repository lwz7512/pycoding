...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.centralX = 300
        self.centralY = 240
        self.distance_sun_to_earth_A = 250
        self.distance_sun_to_earth_B = 150
        self.earthAngle = 0
        self.earthSpeed = 1
        
        self.earthX = self.centralX+self.distance_sun_to_earth_A
    ...
    def update(self, delta_time):
        ...
        a = self.distance_sun_to_earth_A
        b = self.distance_sun_to_earth_B
        # https://en.wikipedia.org/wiki/Ellipse
        # Polar form relative to center
        earth_to_sun_distance_by_radian = (a*b)/math.sqrt((b*math.cos(erad))**2+(a*math.sin(erad))**2)

        earthX = earth_to_sun_distance_by_radian * math.cos(erad)
        earthY = earth_to_sun_distance_by_radian * math.sin(erad)

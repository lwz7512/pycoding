...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.mars = Ball(self.centralX, self.centralY, 20, arcade.color.YELLOW)
    ...
    def update(self, delta_time):
        ...
        self.marsAngle += self.marsSpeed
        mrad = math.radians(self.marsAngle)
        ...
        marsX = self.distance_sun_to_mars * math.cos(mrad)
        marsY = self.distance_sun_to_mars * math.sin(mrad)
        self.mars.update(self.centralX+marsX, self.centralY+marsY)
